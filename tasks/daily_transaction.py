...
from utils.constants import EODHDAPIKEY

SCHEMA = 'public'
INDEX_TABLE = 'australia_stock_index'


class VietnamDailyTransaction(object):
...
class AUstraliaDailyTransaction(object):
    def __init__(self):
        self.engine = get_engine()
        self.schema = 'public'
